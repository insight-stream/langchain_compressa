...
class ChatCompressa(BaseChatModel):
    ...
    # TODO: Implement if ChatCompressa supports streaming. Otherwise delete method.
    # def _stream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatCompressa supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatCompressa supports async generation. Otherwise delete.
